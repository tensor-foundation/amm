...
export const NFT_DEPOSIT_RECEIPT_DISCRIMINATOR = new Uint8Array([
  206, 255, 132, 254, 67, 78, 62, 96,
]);

export function getNftDepositReceiptDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    NFT_DEPOSIT_RECEIPT_DISCRIMINATOR
  );
}
...
export function getNftDepositReceiptEncoder(): Encoder<NftDepositReceiptArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: NFT_DEPOSIT_RECEIPT_DISCRIMINATOR })
  );
}
