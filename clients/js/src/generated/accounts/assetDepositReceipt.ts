...
export const ASSET_DEPOSIT_RECEIPT_DISCRIMINATOR = new Uint8Array([
  147, 18, 99, 58, 249, 8, 196, 221,
]);

export function getAssetDepositReceiptDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ASSET_DEPOSIT_RECEIPT_DISCRIMINATOR
  );
}
...
export function getAssetDepositReceiptEncoder(): Encoder<AssetDepositReceiptArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: ASSET_DEPOSIT_RECEIPT_DISCRIMINATOR,
    })
  );
}
