...
export const WITHDRAW_NFT_CORE_DISCRIMINATOR = new Uint8Array([
  112, 131, 239, 116, 187, 149, 114, 145,
]);

export function getWithdrawNftCoreDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    WITHDRAW_NFT_CORE_DISCRIMINATOR
  );
}
...
export function getWithdrawNftCoreInstructionDataEncoder(): Encoder<WithdrawNftCoreInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: WITHDRAW_NFT_CORE_DISCRIMINATOR })
  );
}
