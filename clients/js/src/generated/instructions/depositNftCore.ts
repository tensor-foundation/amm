...
export const DEPOSIT_NFT_CORE_DISCRIMINATOR = new Uint8Array([
  73, 21, 4, 64, 161, 214, 248, 77,
]);

export function getDepositNftCoreDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DEPOSIT_NFT_CORE_DISCRIMINATOR
  );
}
...
export function getDepositNftCoreInstructionDataEncoder(): Encoder<DepositNftCoreInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: DEPOSIT_NFT_CORE_DISCRIMINATOR })
  );
}
