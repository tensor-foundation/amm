...
export const DEPOSIT_NFT_DISCRIMINATOR = new Uint8Array([
  93, 226, 132, 166, 141, 9, 48, 101,
]);

export function getDepositNftDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DEPOSIT_NFT_DISCRIMINATOR);
}
...
export function getDepositNftInstructionDataEncoder(): Encoder<DepositNftInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: DEPOSIT_NFT_DISCRIMINATOR,
