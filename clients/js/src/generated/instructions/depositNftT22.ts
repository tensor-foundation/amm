...
export const DEPOSIT_NFT_T22_DISCRIMINATOR = new Uint8Array([
  208, 34, 6, 147, 95, 218, 49, 160,
]);

export function getDepositNftT22DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DEPOSIT_NFT_T22_DISCRIMINATOR
  );
}
...
export function getDepositNftT22InstructionDataEncoder(): Encoder<DepositNftT22InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: DEPOSIT_NFT_T22_DISCRIMINATOR })
  );
}
