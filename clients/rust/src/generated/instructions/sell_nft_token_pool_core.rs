...
pub struct SellNftTokenPoolCoreInstructionData {
    discriminator: [u8; 8],
}

impl SellNftTokenPoolCoreInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SellNftTokenPoolCoreInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct SellNftTokenPoolCoreInstructionArgs {
    pub min_price: u64,
}

/// Instruction builder for `SellNftTokenPoolCore`.
///
/// ### Accounts:
///
///   0. `[writable]` owner
...
impl SellNftTokenPoolCoreBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The owner of the pool and the buyer/recipient of the NFT.
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SellNftTokenPoolCore {
...
/// `sell_nft_token_pool_core` CPI accounts.
pub struct SellNftTokenPoolCoreCpiAccounts<'a, 'b> {
    /// The owner of the pool and the buyer/recipient of the NFT.
...
pub struct SellNftTokenPoolCoreCpi<'a, 'b> {
...
impl<'a, 'b> SellNftTokenPoolCoreCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SellNftTokenPoolCoreCpiAccounts<'a, 'b>,
        args: SellNftTokenPoolCoreInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
impl<'a, 'b> SellNftTokenPoolCoreCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SellNftTokenPoolCoreCpiBuilderInstruction {
            __program: program,
            owner: None,
            taker: None,
            rent_payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = SellNftTokenPoolCoreCpi {
...
#[derive(Clone, Debug)]
struct SellNftTokenPoolCoreCpiBuilderInstruction<'a, 'b> {
