...
impl WnsDelist {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = WnsDelistInstructionData::new().try_to_vec().unwrap();
...
struct WnsDelistInstructionData {
    discriminator: [u8; 8],
}

impl WnsDelistInstructionData {
    fn new() -> Self {
        Self {
...
/// Instruction builder for `WnsDelist`.
///
/// ### Accounts:
///
...
/// `wns_delist` CPI accounts.
pub struct WnsDelistCpiAccounts<'a, 'b> {
...
/// `wns_delist` CPI instruction.
pub struct WnsDelistCpi<'a, 'b> {
...
impl<'a, 'b> WnsDelistCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WnsDelistCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WnsDelist` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` single_listing
...
///   14. `[]` distribution_program
///   15. `[]` extra_metas
pub struct WnsDelistCpiBuilder<'a, 'b> {
    instruction: Box<WnsDelistCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WnsDelistCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WnsDelistCpiBuilderInstruction {
            __program: program,
            single_listing: None,
            nft_dest: None,
            nft_mint: None,
...
struct WnsDelistCpiBuilderInstruction<'a, 'b> {
